  ...
  const mapNodes: MapNode[] = [
    {
      id: 'story',
      title: 'Our Timeline',
      subtitle: 'Chapter I: The Meeting & Story',
    ...
    },
    {
      ...
      subtitle: 'Chapter II: Dreams & Wish Lanterns',
      ...
      unlockRequirementText: 'Unlocked at 10+ XP',
      isUnlocked: xp >= 10 || progress.visitedSections.includes('room'),
      isCompleted: (progress.interactedObjects?.length || 0) >= 3,
      xpRewardBadge: '+40 XP',
    ...
    },
    {
      id: 'games-menu',
      title: 'Arcade Arena',
      subtitle: 'Chapter III: 5 Mini-Games',
    ...
    },
    {
      id: 'letter',
      title: 'Royal Letter',
      subtitle: 'Chapter IV: From Afiq to Hanna',
